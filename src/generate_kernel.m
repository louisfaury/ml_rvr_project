function k = generate_kernel(k_str,param1,param2,param3,param4,param5)
    switch k_str
        case 'rbf'
            k = rbf_kernel(param1);
        case 'linear'
        ...
        case 'polysum'
            k = polysum_kernel(param1,param2,param3,param4,param5);  % k(x,x') = (r1+g1<x,x'>)^d1 + (r2+g2<x,x'>)^d2
            % - param1 : d1 
            % - param2 : d2
            % - param3 : r1
            % - param4 : r2 
