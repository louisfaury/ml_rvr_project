...
\begin{document}
	...
	\section{Experimental results}
	{
		...
		\subsection{Cross-validation}
		{
			...
			\newline RVR lies in the family of bayesian methods for regression, it is therefore possible to derive a likelihood expression as in equation (\ref{eq::rvr_likelihood}). In this case, the log-likelihood of the model therefore writes:
			\begin{equation}
