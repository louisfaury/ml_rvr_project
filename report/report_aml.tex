...
\begin{document}
	...
	\section{Theoretical background}
	{
		...
		\subsection{Relevance Vector machine for Regression}
		{
			...
			\newline Furthermore, the RVR provides a posterior distribution over the predictor, leading to 
		}
	...
	\section{Results}
	{
		...
		\subsection{}
		{
			We hereinafter describe different computations and results obtained on the artificial data with both the SVR and the RVR. 
